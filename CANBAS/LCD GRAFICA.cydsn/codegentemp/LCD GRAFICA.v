// ======================================================================
// LCD GRAFICA.v generated from TopDesign.cysch
// 07/12/2019 at 16:56
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("2e5e32ea-66c5-47af-bda2-fb54177ba955"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("578b257b-0ea7-4614-9386-39497e5fc733"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("917a9443-fed5-4c5c-bbba-bb0af93af869"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [1:0] tmpOE__CS_net;
	wire [1:0] tmpFB_1__CS_net;
	wire [1:0] tmpIO_1__CS_net;
	wire [0:0] tmpINTERRUPT_0__CS_net;
	electrical [0:0] tmpSIOVREF__CS_net;

	cy_psoc3_pins_v1_10
		#(.id("e4532122-4c01-4ddf-a0da-79b31940576d"),
		...
		CS
		 (.oe(tmpOE__CS_net),
		  .y({2'b0}),
		  .fb({tmpFB_1__CS_net[1:0]}),
		  .io({tmpIO_1__CS_net[1:0]}),
	...
	assign tmpOE__CS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{2'b11} : {2'b11};

	wire [7:0] tmpOE__DB_net;
	wire [7:0] tmpFB_7__DB_net;
	wire [7:0] tmpIO_7__DB_net;
	...
	cy_psoc3_pins_v1_10
		...
		DB
		 (.oe(tmpOE__DB_net),
		  .y({8'b0}),
		  .fb({tmpFB_7__DB_net[7:0]}),
		  .io({tmpIO_7__DB_net[7:0]}),
	...
	assign tmpOE__DB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};
