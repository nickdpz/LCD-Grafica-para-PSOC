...
#define DB_6			(DB__6__PC)
#define DB_6_INTR	((uint16)((uint16)0x0001u << DB__6__SHIFT))

#define DB_7			(DB__7__PC)
#define DB_7_INTR	((uint16)((uint16)0x0001u << DB__7__SHIFT))

#define DB_INTR_ALL	 ((uint16)(DB_0_INTR| DB_1_INTR| DB_2_INTR| DB_3_INTR| DB_4_INTR| DB_5_INTR| DB_6_INTR| DB_7_INTR))
